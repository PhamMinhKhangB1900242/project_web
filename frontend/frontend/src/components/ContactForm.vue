<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        ...
        <div class="form-group">
            ...
            <Field name="mssv" type="text" class="form-control" v-model="contactLocal.mssv" />
            <ErrorMessage name="mssv" class="error-feedback" />
        </div>
        <div class="form-group">
            <label for="nganh">Học Nghành</label>
            <Field name="nganh" type="text" class="form-control" v-model="contactLocal.nganh" />
        ...
        <div class="form-group">
            <label for="hinhsv">Hình Sinh Viên</label>
            <Field name="hinhsv" type="tel" class="form-control" v-model="contactLocal.hinhsv" />
            <ErrorMessage name="hinhsv" class="error-feedback" />
        </div>
...
export default {
    ...
    data() {
        const contactFormSchema = yup.object().shape({
            ...
            nganh: yup.string().max(20, "mssv tối đa 10 ký tự."),
            phone: yup
                .string()
                .matches(
